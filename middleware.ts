...
export async function middleware(request: NextRequest) {
  ...
  // 공개 경로 정의
  const publicPaths = ['/', '/landing', '/auth/login', '/auth/signup', '/features', '/about', '/developer', '/pricing', '/hello', '/pci-compliance', '/nist-compliance', '/hipaa-compliance', '/ccpa-compliance', '/gdpr-compliance', '/ai-act-compliance'];
