...
console.log('🔧 도메인 테이블 외래 키 제약조건 해결');

async function fixDomainsFK() {
  const client = await pool.connect();

  try {
    console.log('\n📋 1. 현재 도메인 테이블 외래 키 제약조건 확인...');
    ...
    console.log('✅ 현재 도메인 테이블 외래 키 제약조건:');
    ...
    console.log('\n🧪 4. 외래 키 제약조건 확인...');
    // 올바른 UUID 형식으로 테스트
    const testUUID = 'e38552ca-b28e-4165-b85b-d626f2162489';
